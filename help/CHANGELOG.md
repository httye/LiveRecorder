...
**新增文档**
- ✨ 新增 RecorderBinding API 完整文档
  - 类概述、构造函数、核心方法详解
  - 完整的代码示例和最佳实践
  - 常见问题解答和性能考虑
  
- ✨ 新增场景化配置推荐文档
  - 7种场景的完整配置方案（PVP、建筑展示、综艺节目、专业直播、教学教程、服务器监控、电影制作）
  - 性能对比表和调试工具
  - 配置优化建议和常见问题排查
...
- 📝 更新 VitePress 侧边栏配置
  - 添加 RecorderBinding 和场景推荐配置入口

### 🔧 代码质量

- 🐛 修复 LiveCore.java 中的重复导入语句
- 📧 更新 SUPPORT.md 和 README.md 中的联系方式
  - 移除占位符邮箱地址
  - 添加实际的 QQ 联系方式
